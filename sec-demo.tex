...
\marked{
We evaluate the ranking quality by comparing with PRank (PageRank) and FRank (FutureRank). To be specific, we test 110 queries in the field of computer science and asked 3 computer science majors(2 phD students and 1 master student) to label the ranking results. 
P@5 (precision at top 5) of PRank, FRank and \oursystem achieves (65.9\%, 76.9\%, 81.7\%) on the basis of relevant important metric, respectively.
