...
\marked{
We demonstrate our \oursystem system from four aspects: (1) scholarly search, (2) author profiling, (3) performance comparison between Neo4j and RDBMS MySQL and (4) ranking quality evaluation by comparing it with PageRank and FutureRank~\cite{sayyadi2009futurerank}.
}
...
\marked{
We evaluate the ranking quality by comparing it with PRank (PageRank) and FRank (FutureRank). To be specific, we test 110 queries in the field of computer science and ask 3 computer science majors(2 phD students and 1 master student) to label the ranking results.
