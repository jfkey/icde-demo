...
Although ``millwheel" has a little less citations, ``millwheel" gets published in PVLDB which has a higher impact than ICDCS. Moreover, ``millwheel" published in 2013 more recently than ``adaptive" in 2006 as researchers potentially discover recent influential articles.
Thus, ``millwheel" has a high influence and should be ranked first corresponding to \sarank. 
To conclusion, our query result is more effective for searching influential articles due to considering the temporal factor and and assembling the venue and author component.
}
