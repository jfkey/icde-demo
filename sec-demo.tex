...
% 14.8%	19.4 %	45.3%
As can be seen, Neo4j is consistently more efficient than MySQL, which is on average (14.8\%, 37.0\%, 45.3\%) faster for the three types of queries.
...
Neo4j & 0.098 sec.  & 1.82 sec. & 1.97 sec. \\
\hline
\end{tabular}
\end{scriptsize}
\vspace{-3ex}
...
% 3 rows available after 1824376 ms, consumed after another 0 ms
