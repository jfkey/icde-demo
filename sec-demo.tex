...
% More specifically, we consider three types of queries,
% especially for complex queries with more join operations.
...
\marked{Note that ranking algorithm are not reported due to their unavailability in commercial systems such as Google Scholar.}
