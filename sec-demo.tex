...
\marked{
We demonstrate our \oursystem system from four aspects: (1) scholarly search, (2) author profiling, (3) performance comparison between Neo4j and RDBMS MySQL and (4) the ranking quality analysis by case studies and evaluation by comparing with PageRank and FutureRank~\cite{sayyadi2009futurerank}.}
...
\marked{
We evaluate the ranking quality by comparing with PRank (PageRank) and FRank (FutureRank). To be specific, we test 110 queries in the field of computer science and ask 3 computer science students(2 phD students and 1 master student) to label the ranking results.
P@5 (precision at top 5) of PRank, FRank and \oursystem achieve (65.9\%, 76.9\%, 81.7\%) on the basis of relevant important metric, respectively.
Indeed, \oursystem improves the P@5 over (PRank, FRank) by (15.8\%, 4.8\%).
Furthermore, we analyze the ranking quality of PRank, FRank and SARank by case studies in \oursystem. However, the analysis page does not display due to space limitation.
