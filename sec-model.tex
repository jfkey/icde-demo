...
Central to \oursystem is our ranking model that supports heterogeneous scholarly entity ranking.
...
Since 
Besides scholarly articles, \oursystem also supports scholarly data
