...
To fit the various ranking scenarios, \oursystem is equipped with four ranking metrics, namely {\em relevance}, {\em importance}, {\em relevant importance}, {\em citation} and {\em time}. We first elaborate how to rank scholarly articles with these metrics and extend them for other types of entities in the next subsection.
%
