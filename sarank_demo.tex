...
%
To this end, in this paper, we design and develop a scholarly data ranking system \oursystem to support Heterogeneous Scholarly Entity ranking given specific query words. It enables both traditional citation-based and more advanced importance-based rankings. Moreover, it utilizes a popular graph database Neo4j for efficient scholarly data management.
\end{abstract}
