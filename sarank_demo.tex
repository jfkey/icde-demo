...
%
To this end, in this paper, we design and develop a novel scholarly analysis system \oursystem to support heterogeneous scholarly entity ranking. \oursystem is equipped with both traditional relevance- and citation-based and more recent importance-based ranking metrics. Moreover, \oursystem utilizes a popular graph database Neo4j as the storage solution. The linked structures are directly leveraged to facilitate the efficiency of scholarly data management.
