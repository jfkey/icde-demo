...
%why we use graph database. 1. 2. and further why Neo4j. ACID.
%\\
%property graph design based on two principles, what we design? necessary
%\\
%In fact, we can apply any rank algorithm in our database.?
%\\
%support transaction,
