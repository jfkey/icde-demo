...
% Review 1 
% Lack of discussion on updating time-dependent metrics, How to input new data 
% add *scholarly data* component in Figure 1 (a)Framework. when new data arrives, calculate query independent ranking. and update property graph.
...
\marked{
Utilizing {\em Neo4j query engine}, \oursystem supports a variety of graph queries on the property graph to aid scholarly search, such as searching the author's top-k fields of study and searching the affiliation having a higher impact on which venues. When user issue a query, \oursystem first translates it into a Neo4j Cypher query.
