...
\begin{figure}
\centering
\subfigure[{\scriptsize Framework \marked{add scholarly data} }]{\label{fig:framework}
...
\subsection{Graph Query Engine \marked{what kind of query, remove optimization} } \label{subsec:qe}
